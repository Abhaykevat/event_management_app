...
//                 child: Image.network("https://cloud.appwrite.io/v1/storage/buckets/669f4c07003837e8aba8/files/${widget.data.data["image"]}/view?project=669b8f3a0029e49452a3&mode=admin",
//                 fit: BoxFit.cover,
//                 ),
//               ),
...
//                     child: Row(
//                       children: [
//                         Icon(Icons.calendar_month_outlined,size:18,color: Colors.white,),
//                         SizedBox(width: 4,),
...
//                 SizedBox(height: 8,),
//                 Text(" Special Guest",style: TextStyle(
//                   fontSize: 20,
//                   color: Colors.white,fontWeight: FontWeight.w700),),
//                 SizedBox(height: 8,),
//                 Text(widget.data.data["guests"],
//                 style: TextStyle(color: Colors.white),
//                 ),
//                 SizedBox(height: 8,),
//                 Text("Sponsers",style: TextStyle(
//                   fontSize: 20,
//                   color: Colors.white,fontWeight: FontWeight.w700),),
//                 SizedBox(height: 8,),
//                 Text(widget.data.data["sponsers"],
//                 style: TextStyle(color: Colors.white),
//                 ),
//                 SizedBox(height: 8,),
...
//                   color: Colors.white,fontWeight: FontWeight.w700),),
//                 SizedBox(height: 8,),
//                 Text("Event Type : ${widget.data.data["isInPerson"]==true ? "In Person" : "Virtual"}",
//                 style: TextStyle(color: Colors.white),
//                 ),
//                 SizedBox(height: 8,),
          ...
          Stack(children: [
            Container(
              ...
              child: ColorFiltered(
                ...
                child: Image.network(
                  "https://cloud.appwrite.io/v1/storage/buckets/669f4c07003837e8aba8/files/${widget.data.data["image"]}/view?project=669b8f3a0029e49452a3&mode=admin",
                  fit: BoxFit.cover,
                ),
              ),
            ),
