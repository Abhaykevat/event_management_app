        ...
        style: TextStyle(
          ...
          SliverList(delegate:SliverChildBuilderDelegate(
            (context,index)=>ListTile(
              onTap: ()=>Navigator.push(context,MaterialPageRoute(builder: (context)=>EventDetails(data: events[index],))),
              leading: Text(
                "${index +1}",
              style: TextStyle(color: kLightGreen,fontSize: 20),
              ),
            title: Text(events[index].data["name"],style: TextStyle(color: kLightGreen,fontSize: 20),),
            subtitle: Text(events[index].data["location"],style: TextStyle(color: kLightGreen,),),
